...
q="""
INSERT INTO "pynot_eventnotification" ("action", "file", "status", "not_time") 
VALUES (\'SEND\', \'New_Log.txt\', \'PENDING\', \'2018-07-02T09:10:03.123925+00:00\'::timestamptz)
 RETURNING "pynot_eventnotification"."id"', 'time': '0.542'}
"""
