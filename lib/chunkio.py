...
class ChunkIO(io.FileIO):
    ...
    def __init__(self, name, mode='r', closefd=True, offset=0, bytes=None,
        *args, **kwargs):
        ...
        super(ChunkIO, self).__init__(name, mode, closefd, *args, **kwargs)
        self.seek(0)
    ...
    def seek(self, offset, whence=SEEK_SET):
        ...
        """
        if whence == SEEK_SET:
            super(ChunkIO, self).seek(self.offset + offset)
    ...
    def tell(self):
        ...
        """
        return super(ChunkIO, self).tell() - self.offset
    ...
    def read(self, n=-1):
        ...
        if n >= 0:
            ...
            n = min([n, max_n])
            return super(ChunkIO, self).read(n)
        else:
            return self.readall()
